...
//   id: string;
//   name: string;
//   imageUrl: string; // ✅ Changed from image.url to imageUrl
// };
...
//   // Split skills into two rows for scrolling effect
//   const midpoint = Math.ceil(skills.length / 2);
//   const ROW_A = skills.slice(0, midpoint);
//   const ROW_B = skills.slice(midpoint);
...
//             {/* ===== ROW A ===== */}
//             <ScrollVelocityRow baseVelocity={10} direction={1} className="py-6">
//               {ROW_A.map((skill) => (
//                 <div
//                   key={skill.id}
